...
/**
 * Default documentation for MonthSummaryDialog.
 * <p>
...
public class MonthSummaryDialog extends DialogFragment {
    ...
    * @param month standard parameter provided by caller layer.
    * @param year standard parameter provided by caller layer.
    * @return the resulting {@code MonthSummaryDialog} payload.
    */
    ...
    * </p>
    *
    * @param table standard parameter provided by caller layer.
    */
    ...
    /**
    * Executes the {@code loadTableData} operation.
    * <p>
    * Handles specific domain logic pertaining to this component's responsibility. Data input
    * is processed and state mutations or callbacks are executed locally.
    * </p>
